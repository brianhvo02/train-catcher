	...
	return (
        <>
            ...
            <main style={{ display: 'flex' }}>
                <div ref={mapRef} style={{ height: "1000px", width: "1000px", margin: '20px'}}></div>
                <div className={styles.stops}>
                    {data ? data[data.length - 1].stops.map((stop: any) => <Link key={stop.id} style={stop.id == highlight ? {color: 'green'} : {}} href={`/bart/stops/${stop.stop_id}`}>{stop.stop_name}</Link>) : <p>Loading...</p>}
